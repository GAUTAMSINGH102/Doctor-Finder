...
public class Design3ViewAdapter extends RecyclerView.Adapter<Design3ViewAdapter.RecyclerViewHolder> {

    private List<SymptomsModel> symptomsModelArrayList;
    private Context mcontext;

    public Design3ViewAdapter(List<SymptomsModel> symptomsModelArrayList, Context mcontext) {
...
//        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_layout, parent, false);
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.design_3, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerViewHolder holder, int position) {
        ...
        holder.circle_layout.setOnClickListener(new View.OnClickListener() {
            @Override
